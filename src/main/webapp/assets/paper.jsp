					...
					<div class="panel panel-default"  style="height:100%">
						<div class="panel-heading">
							...
							<div class="panel-actions">
								<button type="button" class="btn btn-primary btn-setting"><i class="fa fa-plus"></i>新建</button>
							</div>
						</div>
						<div class="panel-body" style="height:90%">
							<div style="height:100% ;width: 20%;background-color: #999999">
								<div style="height:10%;width:100%;">一级类目</div>
								<div style="height:90%;width:100%">
									<div id="dhead" style="height: 10%">
										<input type="hidden" readonly id="categoriesId1">
										<input type="text" id="categoriesName"> <button class="btn btn-success"><i class="fa fa-search">搜索</i></button>
									</div>
									<div id="dbody" style="height: 80%">

									</div>
									<div id="dfoot" style="height: 10%">
										<input type="text" id="categoriesName1"> <button class="btn btn-info">添加</button>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="modal fade" id="deleteModal">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title">删除试卷将影响习题，是否确认删除？</h4>
				...
				<div class="modal-body">
					<table class="table table-bordered table-striped table-condensed table-hover">
						<tr>
							<td>标题：</td>
							<td><input type="text" id="paperName2"></td>
						</tr>
					</table>
				</div>
				<div class="modal-footer">
